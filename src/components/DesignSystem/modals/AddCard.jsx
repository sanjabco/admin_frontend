...
function AddCard() {
  ...
  return (
    <>
      <button onClick={handleOpen} className='flex items-center justify-center px-10 py-2 rounded-full border border-Red text-Red hover:bg-Pink font-bold'>
      ...
      <Dialog open={open} handler={handleOpen}>
        <DialogHeader className="flex justify-between font-BYekan">
          ...
          <Button className="bg-lightRed p-1" onClick={handleOpen}><XMarkIcon className="text-Red w-5 h-5"></XMarkIcon></Button>
        </DialogHeader>
