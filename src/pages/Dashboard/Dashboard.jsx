...
import {AccountCircle, Storefront, Redeem, ShoppingCart} from "@mui/icons-material";  // Import new icons
...
function Dashboard() {
    ...
    const data = [
        ...
        {icon: <Redeem sx={{width: 40, height: 40}}/>, text: "تعداد نظرسنجی ها", value: 0}, // Placeholder
        {icon: <ShoppingCart sx={{width: 40, height: 40}}/>, text: "اعتبار کسب و کار", value: `${charge}ریال`},
    ];
